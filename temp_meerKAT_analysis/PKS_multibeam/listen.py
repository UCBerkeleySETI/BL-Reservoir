...
while True:
    ...
    if len(new_list) > len(original_list):
        ...
        if int(input_line) ==1:
            ...
            print("bulk_execute_1-11.py "+file_path+" "+str(diff))
            os.system("bulk_execute_1-11.py "+file_path+" "+str(diff))
        elif int(input_line) ==2:
            print("computing node: "+str(input_line))
            file_path = '/mnt_blpd11/datax2/collate_mb/PKS_0371_2018-10-19T02:00/blc12/'+str(diff)
            print("bulk_execute_12-22.py "+file_path+" "+str(diff))
            os.system("bulk_execute_12-22.py "+file_path+" "+str(diff))
        elif int(input_line) ==3:
            print("computing node: "+str(input_line))
            file_path = '/mnt_blpd11/datax2/collate_mb/PKS_0371_2018-10-19T02:00/blc23/'+str(diff)
            print("bulk_execute_23-32.py "+file_path+" "+str(diff))
            os.system("bulk_execute_23-32.py "+file_path+" "+str(diff))
        else:
